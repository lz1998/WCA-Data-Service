...
public interface Top10RankRepository {
    ...
    List<Top10ResultDTO.Top10ItemDTO> findTop10RankSingleResultForContinent(Event event, String region, Gender gender);

    List<Top10ResultDTO.Top10ItemDTO> findTop10RankAverageResultForContinent(Event event, String region, Gender gender);
}
